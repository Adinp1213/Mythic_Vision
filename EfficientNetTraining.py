...
train_dir = r'training path'
validation_dir = r'validation path'
test_dir = r'testing path'
...
# Callbacks
checkpoint = ModelCheckpoint('best_model_EfficientNet.h5', monitor='val_loss', save_best_only=True, verbose=1)
...
results_folder = r'results folder'
