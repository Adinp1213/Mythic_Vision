...
# directories path
train_dir = r'training directory'
validation_dir = r'validation directory'
...
# Callbacks
checkpoint = ModelCheckpoint('best_model_MobileNet.h5', monitor='val_loss', save_best_only=True, verbose=1)
